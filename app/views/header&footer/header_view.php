            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar sidebar-custom">
                    ...
                    <ul class="sidebar-menu">
                        <li><a href="?url=book"><i class="fa fa-book"></i><span>Quản lý sách</span></a></li>
                        <li><a href="?url=user"><i class="fa fa-user-plus"></i><span>Người dùng</span></a></li>
                        <li><a href="?url=muontra"><i class="fa fa-th"></i><span>Mượn / Trả sách</span></a></li>
                    </ul>
                </section>
                <!-- /.sidebar -->
            </aside>
